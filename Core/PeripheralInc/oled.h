...
#define ENABLE_OLED_DYNAMIC_DISPLAY		(0u)/* 注意: OLED 每字符约 1.7ms(逐字节 I2C), 打开会严重阻塞 1ms 控制环,
                                              * 只能在车轮架空调试时临时开启, 跑车必须关掉 */
#define ENABLE_OLED_STATIC_DISPLAY		(1u)
#define ENABLE_SERIVAL_SCOPE					(1u)
