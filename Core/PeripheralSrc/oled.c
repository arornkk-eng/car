...
void OLED_Init(void)
{
	...
	#ifdef ENABLE_OLED_STATIC_DISPLAY
	OLED_ShowString(72,6,"H: 60",16,0);
	OLED_ShowString(120,6,"%",16,0);

	OLED_ShowString(0,2,"Ang: 10",16,0);
	OLED_ShowString(72,2,"V: 12",16,0);
	OLED_ShowString(116,2,"V",16,0);
	OLED_ShowString(0,4,"Distance: 20",16,0);
	OLED_ShowString(104,4,"cm",16,0);    
	
	OLED_ShowString(0,6,"T: 25",16,0);
	OLED_ShowString(48,6,"C",16,0);

	OLED_ShowCHinese(36,0,0,0);	/* Jiang */
	OLED_ShowCHinese(52,0,1,0);	/* Ke */
	OLED_ShowCHinese(68,0,2,0);	/* Zhi */
	OLED_ShowCHinese(82,0,3,0);	/* Neng */
	#endif
}
